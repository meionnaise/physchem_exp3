...
The below python function (see Appendix \ref{appx:part1_code} for full script) substitutes above given values, equations (\ref{eq:ecell}), (\ref{eq:K12}), and (\ref{eq:f12}) to equation (\ref{eq:ket}).
